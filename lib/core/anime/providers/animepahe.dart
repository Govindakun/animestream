...
class AnimePahe extends AnimeProvider {
  ...
  Future<List<Map<String, String?>>> search(String query) async {
    ...
    final String url = "https://animepahe.com/api?m=search&q=$query";
  ...
  Future<List<Map<String, dynamic>>> getAnimeEpisodeLink(String session, {bool dub = false}) async {
    List list = [];
    final String url = "https://animepahe.com/api?m=release&id=$session&sort=episode_asc`";
    ...
    for (int i = 0; i < list.length; i++) {
      final episodeLink = "https://animepahe.com/play/$session/${list[i]['session']}";
